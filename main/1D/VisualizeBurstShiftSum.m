%% VisualizeBurstShiftSum - Visualize Motion Stack Development %% 
%% Copyright  (c) 2022 aR
...
%For shiftmotion in opposite direction; change the following order in the
%main scriptfor declaring 0: MotionImage = VisualizeBurstShiftSum(DoubleBurst,SlopeSet(islope),0); 

%Consider having seperate scripts for horizontal motion and vertical motion for known motion-specific applications.

function [ShiftedImg] = VisualizeBurstShiftSum(DoubleBurst, TVSlope, SUSlope)
