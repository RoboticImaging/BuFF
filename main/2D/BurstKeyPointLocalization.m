...
function [KeyPoints] = BurstKeyPointLocalization(BuFFStack, Height, Width, Octave, Level, SpeedU, SpeedV, x, y, OutlierPixel, PeakThreshold, Count)
...
KeyPoints.SpeedU = round(SpeedU);
KeyPoints.SpeedV = round(SpeedV);
